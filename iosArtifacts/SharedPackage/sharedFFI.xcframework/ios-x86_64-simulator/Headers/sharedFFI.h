...
int32_t uniffi_shared_klc_fn_func_add_stuff(int32_t left, int32_t right, RustCallStatus *_Nonnull out_status
);
...
uint16_t uniffi_shared_klc_checksum_func_add_stuff(void
